function [res] = read_force_BUSH(obj)
...
%     res(i).GIDs = data.GRID(idx);
    res(i).Fx = data.FX(idx);
    res(i).Fy = data.FY(idx);
    res(i).Fz = data.FZ(idx);
    res(i).Mx = data.MX(idx);
    res(i).My = data.MY(idx);
    res(i).Mz = data.MZ(idx);
end
end
