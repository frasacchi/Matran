...
% BulkDataMask.PCOMP  = 'mni.bulk.Property';
...
BulkDataMask.SPLINE3 = 'mni.bulk.AeroelasticSpline';
BulkDataMask.SPLINE4 = 'mni.bulk.AeroelasticSpline';
BulkDataMask.SPLINE5 = 'mni.bulk.AeroelasticSpline';
BulkDataMask.SPLINE6 = 'mni.bulk.AeroelasticSpline';
BulkDataMask.SPLINE7 = 'mni.bulk.AeroelasticSpline';
BulkDataMask.CQUAD4  = 'mni.bulk.Shell';
BulkDataMask.CTRIA3  = 'mni.bulk.Shell';
BulkDataMask.RBE2    = 'mni.bulk.Constraint';
BulkDataMask.RBE3    = 'mni.bulk.Constraint';
% BulkDataMask.RJOINT  = 'mni.bulk.Constraint';
BulkDataMask.AEFACT  = 'mni.bulk.AeroList';
BulkDataMask.AELIST  = 'mni.bulk.AeroList';
BulkDataMask.SET1    = 'mni.bulk.List';
BulkDataMask.ASET1   = 'mni.bulk.List';
BulkDataMask.ASET    = 'mni.bulk.List';
BulkDataMask.PAERO1  = 'mni.bulk.AeroProp';
