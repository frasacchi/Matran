    ...
    methods
        function obj = PBEAM(PID,MID,Sections,opts)
            ...
            arguments
                ...
                opts.S (2,1) double = [0;0]
                opts.NSI (2,1) double = [0;0]
                opts.CW (2,1) double = [0;0]
                opts.MA (2,1) double = [0;0]
                opts.MB (2,1) double = [0;0]
                opts.NA (2,1) double = [0;0]
                opts.NB (2,1) double = [0;0]
            end 
            obj.PID = PID;
            obj.MID = MID;
