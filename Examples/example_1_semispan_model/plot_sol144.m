...
%extract the data
res_disp =  mni.result.f06(fullfile('data','sol144.f06')).read_disp;
res_aeroP = mni.result.f06(fullfile('data','sol144.f06')).read_aeroP;
res_aeroF = mni.result.f06(fullfile('data','sol144.f06')).read_aeroF;
